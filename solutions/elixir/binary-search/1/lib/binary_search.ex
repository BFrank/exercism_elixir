defmodule BinarySearch do
  ...
  def search(numbers, key) when is_tuple(numbers) do
    BinarySearch.search(numbers, key, 0 , tuple_size(numbers))  
  end  
 ...
 def search(numbers, key, from, to) do
   ...
   cond do
     ...
     from == to -> :not_found
     elem(numbers, mid) < key -> BinarySearch.search(numbers, key, mid + 1, to)
     elem(numbers, mid) > key -> BinarySearch.search(numbers, key, from, mid - 1)
   end
 end
